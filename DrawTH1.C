...
void DrawTH1(TString obsID="d0sliding", Int_t nbin=50, Double_t bmin=0, Double_t bmax=100, Bool_t drawstack = true){
  ...
  std::pair<std::vector<Double_t>, Double_t> munuqq = getvalues(obsID, "munuqq", mass, "n/a", 1.e5, 8, jalg);
  std::pair<std::vector<Double_t>, Double_t> Zmumu = getvalues(obsID, "Zmumu", mass, "n/a", 1.e5, 8, jalg);
  std::pair<std::vector<Double_t>, Double_t> Ztautau = getvalues(obsID, "Ztautau", mass, "n/a", 1.e5, 8, jalg);
  std::pair<std::vector<Double_t>, Double_t> Zuds = getvalues(obsID, "Zuds",mass, "n/a", 1.e5, 8, jalg);
  std::pair<std::vector<Double_t>, Double_t> Zbb = getvalues(obsID, "Zbb",mass, "n/a", 1.e5, 8, jalg);
  std::pair<std::vector<Double_t>, Double_t> Zcc = getvalues(obsID, "Zcc",mass, "n/a", 1.e5, 8, jalg);
  ...
  TH1F *h_signalM = new TH1F(Form("signal%d",mass),Form("signal%d",mass),nbin,bmin,bmax);
